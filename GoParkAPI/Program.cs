...
builder.Services.AddCors(options =>
{
    options.AddDefaultPolicy(policy =>
    {
        ...
        policy.WithOrigins("http://127.0.0.1:5500", "http://localhost:5173", "https://www.mygoparking.com", "https://blue-field-045272c00.5.azurestaticapps.net", "https://mygoparking.com", "https://sandbox-web-pay.line.me").AllowAnyMethod().AllowAnyHeader().AllowCredentials();
    });
});
