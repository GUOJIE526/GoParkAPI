...
builder.Services.AddCors(options =>
{
    options.AddDefaultPolicy(policy =>
    {
        ...
        policy.WithOrigins("http://127.0.0.1:5500", "http://localhost:5173", "https://blue-field-045272c00.5.azurestaticapps.net").AllowAnyMethod().AllowAnyHeader().AllowCredentials();
    });
});
