...
public partial class EasyParkContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CarId).HasName("PK__Car__4C9A0DB379A1B0CC");
        ...
        {
            entity.HasKey(e => e.CouponId).HasName("PK__Coupon__58CF6389F1B49428");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Customer__B9BE370F1B4BAD03");
        ...
        {
            entity.HasKey(e => e.DealId).HasName("PK__DealReco__C012A76CDC028A2D");
        ...
        {
            entity.HasKey(e => e.ApplyId).HasName("PK__MonApply__8260CA8215077C7F");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__ParkingL__DC9AC9555298087E");
        ...
        {
            entity.HasKey(e => e.SlotId).HasName("PK__ParkingS__971A01BB03A28692");
        ...
        {
            entity.HasKey(e => e.RevenueId).HasName("PK__Revenue__3DF902E9338098E7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Survey__3213E83F89B37A1B");
        ...
        {
            entity.HasKey(e => e.TranId).HasName("PK__Transact__A67F8A20C11BD921");
