...
namespace GoParkAPI.Controllers
{
    ...
    [ApiController]
    public class ResServiceController : ControllerBase
    {
        private readonly EasyParkContext _context;

        public ResServiceController(EasyParkContext context)
        {
            _context = context;
        }
